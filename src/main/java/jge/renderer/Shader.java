...
public class Shader {
    ...
    public void compile() {
        ...
        // First load and compare the vertex shader
        ...
        if (success == GL_FALSE) {
            ...
            Log.error(glGetShaderInfoLog(vertexID, len));
            assert false : "";
        }

        // First load and compare the fragment shader
        ...
        if (success == GL_FALSE) {
            ...
            Log.error(glGetShaderInfoLog(fragmentID, len));
            assert false : "";
        }

        // Link shaders amd check for errors
        ...
        if (success == GL_FALSE) {
            ...
            Log.error(glGetShaderInfoLog(shaderProgramID, len));
            assert false : "";
        }
